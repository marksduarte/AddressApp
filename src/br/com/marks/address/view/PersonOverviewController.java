...
import br.com.marks.address.MainApp;
import br.com.marks.address.model.Person;
import br.com.marks.address.util.DateUtil;
...
public class PersonOverviewController {
    ...
    private void handleDeletePerson(){
        int selectedPerson = personTable.getSelectionModel().getSelectedIndex();
        if(selectedPerson >= 0) {
